...
const UpdateUser = () => { const [updateMode, setUpdateMode] = useState('default');
    switch (updateMode) {
        case 'edit profile':
            return <EditProfile/>;
        ...
        default: return ( <div>
                              <button onClick={() => setUpdateMode('default')}>Edit profile</button>
                               <button onClick={() => setUpdateMode('edit')}>Change password</button>
                            </div>
            )
